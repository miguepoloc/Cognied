...
from .views import (
    ...
    PreguntaView,
    ProgramaAcademicoView,
    RespuestaView,
    SexoView,
    UsuarioDetalle,
    UsuarioEncuestaView,
    UsuarioRespuestaView,
    UsuarioView,
    ViewPreguntaRespuestaView,
    ViewRespuestaEncuestasView,
    ViewUsuarioRespuestaView,
)
...
urlpatterns = [
    ...
    path('encuesta_detallex', EncuestaDetallex.as_view(), name='encuesta_detallex'),
